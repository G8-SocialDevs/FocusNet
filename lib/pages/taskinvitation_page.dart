...
class TaskInvitationPage extends StatefulWidget {
  static const String routeName = '/taskinvitation';
  final int userId;
  final int invitationId;
  final int taskId;
  final bool isFromR;

  const TaskInvitationPage(
      {Key? key,
  ...
  @override
  _TaskInvitationPageState createState() => _TaskInvitationPageState();
}

class _TaskInvitationPageState extends State<TaskInvitationPage> {
